...
public class UpdateNote extends HttpServlet {
	...
	final static String URL = "jdbc:mysql://124.70.177.207/linux_exam";
	final static String USER = "root";
	final static String PASS = "Dxc123566!";
	final static String SQL_UPDATE_NOTEPAD = "UPDATE t_notepad SET notepadContent= ? , notepadTime = ? WHERE id=?";
